...
const Footer = () => {
  return (
    <footer className="mt-48 p-4 py-8 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
        <div className="mx-auto w-full text-center">
            <div className="grid lg:grid-cols-3">
                <Link href="#" className="flex items-center mb-4 text-2xl font-semibold text-gray-900 lg:mb-0 dark:text-white">
            ...
            <div className="sm:items-center sm:justify-between sm:flex">
                <span className="block text-sm text-gray-500 dark:text-gray-400">© 2021-2022 <Link href="https://flowbite.com" className="hover:underline">Academy</Link>. All Rights Reserved.</span>
